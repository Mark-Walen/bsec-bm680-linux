 ...
 *
 * @brief
 * Contains the internal multi-instance API for BSEC
 *
 */
...
extern "C"
{
 ...
 /*! @addtogroup bsec_lib_interface BSEC C Interface
 *  @brief Internal multi-instance interface of BSEC signal processing library
 *
 * ### Interface usage
 * 
